...
namespace Web码神工具.Controllers
{
    ...
    public class DataModelController : Controller
    {
        ...
        public string GenTable(ModelConfig cfg)
        {
            ...
            var table = DAL.Create(cfg.ConnName).Tables.Find(f=>f.ToString() == tabName);
            ...
            if (Directory.Exists(templateDir)) 
            {
                ...
                if (ds != null && ds.Length > 0)
                {
                    foreach (var item in ds)
                    {
                        ...
                        var res = GenTemplate(item, table, cfg);
                        ...
                        System.IO.File.WriteAllText(fileName, res, Encoding.UTF8);
                    }
                }
            }
    ...
    public class DataModel
    {
        ...
        //        catch (Exception ex)
        //        {
        //            MessageBox.Show(ex.ToString(), MediaTypeNames.Text);
        //            return;
        //        }
        ...
        //    catch (Exception ex)
        //    {
        //        MessageBox.Show(ex.ToString(), MediaTypeNames.Text, MessageBoxButtons.OK, MessageBoxIcon.Error);
        //    }
        ...
        //    {
        //        MessageBox.Show(MediaTypeNames.Text, "数据库架构为空！", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        //        return;
        //    }
        ...
        //    catch (Exception ex)
        //    {
        //        MessageBox.Show(ex.Message, MediaTypeNames.Text, MessageBoxButtons.OK, MessageBoxIcon.Error);
        //        return;
        //    }
        //}
